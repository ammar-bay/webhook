...
const FacebookMessengerWebhookRouter = (io) => {
  const router = require("express").Router();

  // getting notification from facebook
  router.post("/", async (req, res) => {
    // Check the Incoming webhook message
    console.log("POST request at /fbmessenger endpoint");
  ...
  router.get("/", (req, res) => {
    console.log("GET request at /fbmessenger endpoint");
    /**
...
module.exports = FacebookMessengerWebhookRouter;
